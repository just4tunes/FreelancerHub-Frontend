    ...
    return (
      <div className="w-full min-h-screen flex flex-col md:flex-row items-center justify-center px-4 py-10 xl:px-24">
        ...
        <div className="w-full max-w-md rounded-lg p-6 xl:w-[50%]">
          <h2 className="text-2xl font-bold text-[#266464] mb-6">Get in Touch</h2>
          ...
          <form className="space-y-4">
            ...
            {/* Your Question Field */}
            <div>
              <label className="block text-[#266464] font-medium">
                Your Question
              </label>
              <input
                type="text"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full min-h-[48px] px-4 py-2 border border-[#266464] rounded-md focus:outline-none resize-y"
              />
            </div>
